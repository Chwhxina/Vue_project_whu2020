        ...
        methods: {
            ...
            async onSubmit(formName) {
                ...
                this.$refs[formName].validate(async (valid) => {
                    if (valid) {
                        let res = await createGovernment({object: this.createForm.object, password: this.createForm.password, realname: this.createForm.realname, address: this.createForm.address});
